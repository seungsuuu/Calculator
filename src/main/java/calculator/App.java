...
public class App {
    public static void main(String[] args) {
        ...
        ArithmeticCalculator<Double> calAri = new ArithmeticCalculator<>( new ArrayList<>(), Double.class); // ArithmeticCalculator 객체 생성 시, ArrayList 를 생성하고 초기화 및 사칙연산 클래스들 생성
